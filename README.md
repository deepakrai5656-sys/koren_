...
## Movies Explain integration
This version includes CORS for `https://moviesexplain.in` and localhost development. Deploy this API first, then put the resulting public API URL into `kdrama-config.js` on the Movies Explain site.
